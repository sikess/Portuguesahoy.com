...
function add_less_script() {
    wp_deregister_script( 'less' );
    wp_register_script( 'less', 'https://raw.github.com/less/less.js/master/dist/less-1.4.1.min.js');
    wp_enqueue_script( 'less' );
}    
add_action('wp_enqueue_scripts', 'add_less_script');
